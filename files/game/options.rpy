...
define config.name = "Доки Доки Послеобраз"
...
define build.name = "DokiDokiAfterimage"
...
default preferences.sfx_volume = 1.5
...
define config.save_directory = "DokiDokiAfterimage"




define config.window_icon = "mod_assets/AfterimageLogo.png"
...
init python:
    ...
    build.classify("game/images/**", "scripts all")
    build.classify("game/audio/**", "scripts all")
