label af4_main:
    ...
    mc "Должен сказать, эта глазурь напоминает кексы Нацуки."
    show sayori smile5 ud at f11
    s "Не забудь сказать, что бы она принесла своих блюд, когда мы встретимся."
    show sayori curious2 uu at t11
    mc "Ха-ха. Нацуки сейчас стала ещё лучше!"
    show sayori curious2 uu at focus(640, 0.85)
    "Я беру свой телефон, чтобы показать ей фотографии, которые Нацуки прислала раньше."
    scene bg bedroom_night2
    show sayori surprise2 uu at t11
    mc "Она рассказала, как взяла всю кухню колледжа и научилась новым рецептам!"
    mc "Она не подведёт нас, если принесёт свои блюда."
    show sayori surprise1 uu at h11
    s "Тогда скажи ей об этом сейчас!"
    show sayori serious1 dd at t11
    mc "Хорошо-хорошо!"
    "Я включаю свой ноутбук."
    "Похоже, Юри добавила меня."
    "\"[player], я надеюсь это сообщение дойдёт до тебя. Нацуки пришла ко мне сегодня и рассказала про вас. Как там Сайори?\""
    play music thewayhome fadein 1.0
    stop ambient fadeout(1.0)
    "На экране светится сообщение, полученное от неё несколько часов назад."
    show sayori serious1 dd at f11
    s "Дай мне поговорить с ней."
    show sayori at fhide(t=1.0)
    "Сайори садится на моё место и вливается в меня. Я чувствую, как меня окутывает холод."
    mc "Что?.. Как ты собираешься это сделать?"
    s "Просто сиди и наблюдай."
    mc "Что..."
    s "Не двигайся."
    "Внезапно, её тон стал серьёзным."
    "Я покорно сижу, оставаясь в позе печати."
    scene cg coincide1 with dissolve
    $ persistent.cg8 = True
    "Вскоре, я замечаю, как туман проникает в одежду, словно нефрит, чудом вынырнувший из замёрзшего озера."
    "Пятна воды на его поверхности медленно испаряются, наполняясь теплом моего тела."
    "Красные полосы проходят через швы ткани, деликатно сшивая её."
    "Оттуда, где её одежда не может скрыть, я вижу её неприкрытые формы, несравнимые и убедительные."
    "Её руки скользят вокруг моих, прежде чем окончательно слиться в одном измерении с моими."
    "Мой пульс скачет как сумашедший, а сердце посылает кипящую кровь в самые отдалённые сосуды организма."
    "Серцебиение наших сердец синхронизируется, и загадочный гул в груди подсказывает мне, что делать."
    "Моя рука поднимается, и я вижу, как голубые контуры следуют за ней, покрывая мою кожу циановой дымкой."
    scene cg coincide2 with dissolve
    $ persistent.cg9 = True
    "Я чувствую, как её волосы падают мне на лоб, касаясь кожи, а голова становится ещё тяжелее."
    "Но моё тело становится легче и теплее."
    "Не по своей воле я, в стиле Сайори, начинаю переписку с Юри"
    s "Хей, Юри!"
    "..."
    "По-началу Юри не выкупает прикола, однако и не думает, что с ней говорю я."
    "К счастью, Юри не из таких, поэтому вскоре сговаривается с Сайори. В этот момент присоединяется Нацуки"
    "Втроём они противоречат пространству и времени, встречаясь в оживлённой беседе."
    "Я так рад, видеть их, беседующими по душам, хоть подглядывать за разговором девушек и неприлично, другого выхода у нас нет. Ведь так?"
    "Они обсуждают с Сайори все подробности жизни, рассказывают о колледже, о книгах и фильмах, прочитанных и просмотренных за последние годы."
    "Нацуки показывает свои стихи,"
    "Юри описывает своего персонажа в фентези-новелле,"
    "Сайори в своём духе, задаёт много вопросов о еде, в особенности о фирменных рецептах Нацуки."
    "Они уже планируют, чем заниматься после встречи, а Юри и Нацуки интересуются, как изменился город после их отъезда."
    "Разговор постепенно раскрывается, всё идёт к тому собранию перед фестивалем"
    "Юри удивительно изменилась."
    "Её элегантный словарный запас остался прежним, однако вся нерешительность и нервозность куда-то пропала."
    "Она приветливая и понимающая,"
    "она связывает логику в своих словах и больше не замыкается в себе. Я больше не вижу в её фразах застенчивости и комплексов."
    "Что касается Нацуки, то она своей жизнерадостностью напоминает Сайори, как только достаточно разговорится"
    "Можно сказать, что Нацуки и Юри отлично ладят, и это греет моё сердце, когда я вижу, что они могут поговорить друг с другом после стольких лет."
    "Диалог заканчивается на хорошей ноте и с назначенным временем встречи."
