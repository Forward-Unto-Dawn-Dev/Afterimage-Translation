...
define -3 text_outline_color = "#063330"
...
init -1 style window:
    ...
    background Image("mod_assets/textbox2.png", xalign=0.5, yalign=1.0)
...
init -1 style namebox:
    ...
    background Frame("mod_assets/namebox1.png", gui.namebox_borders, tile=gui.namebox_tile, xalign=gui.name_xalign)
...
init 499 image ctc:
    xalign 0.79 yalign 0.95 xoffset -5 alpha 0.0 subpixel True
    "gui/ctc.png"
    block:
    ...
    vbox:
        ...
        if not persistent.autoload or not main_menu:
            ...
            if main_menu:
                ...
                textbutton _("Сохраниться") action [ShowMenu("save"), SensitiveIf(renpy.get_screen("save") == None)]

            textbutton _("Загрузиться") action [ShowMenu("load"), SensitiveIf(renpy.get_screen("load") == None)]
            textbutton _("Галерея") action [ShowMenu("gallery"), SensitiveIf(renpy.get_screen("gallery") is None)]
...
init -1 style navigation_button_text:
    ...
    font "gui/font/Ramona.ttf"
    color "#fff"
    outlines [(4, text_outline_color, 0, 0), (2, text_outline_color, 2, 2)]
    hover_outlines [(4, "#96bab8", 0, 0), (2, "#96bab8", 2, 2)]
    insensitive_outlines [(4, "#b7dfdc", 0, 0), (2, "#b7dfdc", 2, 2)]

init -1 style navigation_button_text2:
    properties gui.button_text_properties("navigation_button")
    font "mod_assets/font/汉仪长宋简.ttf"
    color "#fff"
    outlines [(4, text_outline_color, 0, 0), (2, text_outline_color, 2, 2)]
    hover_outlines [(4, "#96bab8", 0, 0), (2, "#96bab8", 2, 2)]
    insensitive_outlines [(4, "#b7dfdc", 0, 0), (2, "#b7dfdc", 2, 2)]
...
init -1 style game_menu_outer_frame:
    ...
    background "mod_assets/main_menu_layer2.png"
...
init -1 style game_menu_label_text2:
    font "mod_assets/font/汉仪长宋简.ttf"
    size gui.title_text_size
    color "#fff"
    outlines [(6, text_outline_color, 0, 0), (3, text_outline_color, 2, 2)]
            ...
            grid gui.file_slot_cols gui.file_slot_rows:
                ...
                for i in range(gui.file_slot_cols * gui.file_slot_rows):
                    ...
                    button:
                        ...
                        add FileScreenshot(slot, empty="mod_assets/slot_idle_background_empty.png") xalign 0.5
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "check"
                    label _("Пропуск")
                    textbutton _("{size=18}Неувиденного текста") action Preference("skip", "toggle")
...
init -1 style pref_label_text:
    ...
    size 24
    color "#fff"
    outlines [(3, "#063330", 0, 0), (1, "#063330", 1, 1)]
    yalign 1.0

init -1 style pref_label_text2:
    font "mod_assets/font/汉仪长宋简.ttf"
    size 24
    color "#fff"
    outlines [(3, "#063330", 0, 0), (1, "#063330", 1, 1)]
...
init -1 style radio_button_text:
    ...
    font "gui/font/Klyakson.ttf"
    outlines []
init -1 style radio_button_text2:
    properties gui.button_text_properties("radio_button")
    font "mod_assets/font/汉仪长宋简.ttf"
    outlines []
...
init -1 style check_button_text2:
    properties gui.button_text_properties("check_button")
    font "mod_assets/font/汉仪长宋简.ttf"
    outlines []
