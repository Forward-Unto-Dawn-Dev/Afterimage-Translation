...
init python:
    if renpy.android: 
        try:
            if not os.access(os.path.realpath("/sdcard/Android/data/"+package_name+"/game/"), os.F_OK): 
                os.mkdir(os.path.realpath("/sdcard/Android/data/"+package_name) + "/game") 
            file(os.path.realpath("/sdcard/Android/data/"+package_name+"/game/poemwords.txt")) 
        except: open(os.path.realpath("/sdcard/Android/data/"+package_name+"/game/poemwords.txt"), "wb").write(renpy.file("poemwords.txt").read()) 
